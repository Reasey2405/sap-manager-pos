...
export const CONDITION_TYPES = ['PRODUCT', 'CATEGORY', 'CUSTOMER_GROUP', 'PAYMENT_METHOD', 'DISCOUNT_CARD', 'TIME_OF_DAY', 'DAY_OF_WEEK', 'QUANTITY_THRESHOLD', 'BASKET_VALUE', 'FIRST_PURCHASE', 'COUPON_CODE']
...
export const CONDITION_TYPE_OPERATORS = {
    ...
    DISCOUNT_CARD: ['EQUALS', 'NOT_EQUALS', 'IN', 'NOT_IN'],
...
export const CONDITION_VALUE_HINTS = {
    ...
    DISCOUNT_CARD: 'Discount card code(s), comma-separated for IN/NOT_IN',
