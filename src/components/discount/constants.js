...
export const DISCOUNT_TYPES = ['PERCENTAGE', 'FIXED_AMOUNT', 'TIERED', 'BUY_X_GET_Y', 'BUY_COMBO_GET_Y', 'FREE_ITEM', 'REDUCE_TO_CLEAR']
...
export const COUPON_TYPES = ['SINGLE_USE', 'MULTI_USE']
export const BUY_X_GET_Y_SCOPES = ['SPECIFIC_PRODUCTS', 'ANY_PRODUCT']
