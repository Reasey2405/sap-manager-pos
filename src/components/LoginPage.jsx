    ...
    <div className="login-page">
      ...
      <div className="login-container">
        ...
        <div className="login-brand">
          <div className="login-logo">
            <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="2" y="2" width="44" height="44" rx="12" stroke="currentColor" strokeWidth="2.5" />
              <path
                d="M14 34V20l10-8 10 8v14H26v-8h-4v8H14z"
                fill="currentColor"
                opacity="0.15"
              />
              <path
        ...
        <form className="login-card" onSubmit={handleSubmit} autoComplete="off">
          ...
          {/* Username */}
          <div className={`login-field ${focusedField === 'username' ? 'focused' : ''} ${username ? 'has-value' : ''}`}>
          ...
          >
            {loading ? (
              ...
              <>
                <span>Sign In</span>
                <svg viewBox="0 0 20 20" fill="currentColor" className="login-submit-arrow">
                  <path
                    fillRule="evenodd"
